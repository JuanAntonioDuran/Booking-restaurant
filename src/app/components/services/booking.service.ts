...
export class BookingService {
  ...
  new Booking( 1, "Juan Pérez", "+34 600 123 456", "juan.perez@example.com", 4, "Prefiere mesa cerca de la ventana.", new
    ...
    booking: Booking = new Booking( 10, "Elena Ruiz", "+34 600 445 566", "elena.ruiz@example.com", 6, "Mesa con buena iluminación para fotos.", new Date("2024-12-28T20:30:00"), new Date("2024-12-03T12:40:00"),BookingStatus.CONFIRM )
  ...
  constructor() { }
    ...
    deleteBooking(id: number) {
      for (let index = 0; index < this.BookingList.length; index++) {
        if (this.BookingList[index].id == id) {
